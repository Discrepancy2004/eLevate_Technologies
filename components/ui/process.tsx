...
export const StickyScroll = ({
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    // Improved breakpoint logic for better transitions
    // Creates more natural breakpoints that account for the my-20 spacing
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "sticky top-10 hidden h-80 w-[32rem] overflow-hidden rounded-md bg-white lg:block",
          contentClassName
        )}
      >
